...
function Landing() {
  ...
  return (
    <div className="relative flex flex-col items-center justify-center min-h-screen overflow-hidden bg-slate-950 text-slate-100 font-sans antialiased">
      ...
      {/* Main Content */}
      <main className="z-10 max-w-4xl px-6 text-center">
        {/* Logo Tag */}
        <div className="inline-flex items-center gap-2.5 px-3.5 py-1.5 mb-8 rounded-full bg-brand-500/10 border border-brand-500/20 text-brand-400 text-xs font-semibold uppercase tracking-wider animate-pulse">
        ...
        <p className="text-base sm:text-lg text-slate-400 max-w-2xl mx-auto mb-10 leading-relaxed">
          TaskFlow brings team members together on a collaborative, real-time board. Drag tasks, update priorities, and watch everything sync instantly across devices.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-3xl mx-auto text-left">
          <div className="p-6 rounded-xl bg-white/[0.02] border border-white/5 backdrop-blur-sm">
            ...
            <h3 className="text-slate-200 font-semibold mb-2">Live Sync</h3>
          ...
          <div className="p-6 rounded-xl bg-white/[0.02] border border-white/5 backdrop-blur-sm">
            ...
            <h3 className="text-slate-200 font-semibold mb-2">Role Permissions</h3>
            <p className="text-xs text-slate-400 leading-relaxed">
          ...
          <div className="p-6 rounded-xl bg-white/[0.02] border border-white/5 backdrop-blur-sm">
            ...
            <h3 className="text-slate-200 font-semibold mb-2">Rich Tasks</h3>
            <p className="text-xs text-slate-400 leading-relaxed">
